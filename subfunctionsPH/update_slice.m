function update_slice(probe_atlas_gui,hFig)
	%global probe_atlas_gui
	try
		% Get guidata
    ...
    probe_vector = probe_ref_top - probe_ref_bottom;
		%}
		probe_vector_ccf = gui_data.probe_vector_ccf;
		probe_ref_top = probe_vector_ccf(1,:);
		probe_ref_bottom = probe_vector_ccf(2,:);
		probe_vector = probe_ref_top - probe_ref_bottom;
