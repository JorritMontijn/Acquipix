function [sStimParams,sStimObject,sStimTypeList] = getFlashObjects(sStimParams)
	%getFlashObjects Builds flash objects
	%	[sStimParams,sStimObject,sStimTypeList] = getFlashObjects(sStimParams)
	...
	cellFieldDefaults = ...
		...
		'vecLuminance',[1];... %luminance of flash, (dbl, 0-1)
